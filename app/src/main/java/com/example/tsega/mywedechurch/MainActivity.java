...
import layout.My_church_Fragment;
   ...
   @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
       ...
       MainFragment  mainFragment = new MainFragment();
            ...
            My_church_Fragment my_church_fragment = new My_church_Fragment();
            FragmentManager manager =getSupportFragmentManager();
            manager.beginTransaction().replace(R.id.main_container, my_church_fragment).commit();
